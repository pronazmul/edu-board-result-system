...
<body class="">
    <section class="vbox">
        <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            <div class="navbar-header aside-md dk">
                ...
                <a href="index.html" class="navbar-brand"> <img src="images/logo.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs">ADMIN</span> </a>
            ...
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="images/nazmul.png" alt="..."> </span> Pro Nazmul <b class="caret"></b> </a>
                        ...
                        <section class="w-f scrollable">
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                <div class="clearfix wrapper dk nav-user hidden-xs">
                                    <div class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb avatar pull-left m-r"> <img src="images/nazmul.png" class="dker" alt="..."> <i class="on md b-black"></i> </span> <span class="hidden-nav-xs clear"> <span class="block m-t-xs"> <strong class="font-bold text-lt">Pro Nazmul</strong> <b class="caret"></b> </span> <span class="text-muted text-xs block">Web Developer</span> </span>
                                        </a>
    ...
    <nav class="nav-primary hidden-xs">
        <div class="text-muted text-sm hidden-nav-xs padder m-t-sm m-b-sm">Nazmul Pro</div>
        ...
        <li>
            ...
            <ul class="nav dk">
        <li>
            <a href="all_student.php" class="auto"> <i class="i i-dot"></i> <span>All_Students</span> </a>
        </li>
        <li>
            <a href="add_student.php" class="auto"> <i class="i i-dot"></i> <span>Add_Student</span> </a>
        </li>
         <li>
            <a href="check_result.php" class="auto"> <i class="i i-dot"></i> <span>Result Check</span> </a>
        </li>
