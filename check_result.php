...
<body>
	...
	<div class="wraper">
		...
		<div class="w-main">
			<button style="padding: 5px 10px; margin: 5px 0px 0px 5px;"><a href="dashbord.php" style="text-decoration: none;">Back</a></button>
	...
	<form action="search.php" method="POST">
		 	...
		 	<select name="board" disabled="">
				  ...
				  <option value="dibs">DIBS(Dhaka)</option>
					...
					<tr>
						<td></td>
						<td><input type="reset" value="reset"><input name="submit" type="submit" value="submit"></td>
					</tr>
				</table>
	</form>
		...
		<div class="w-footer">
			<div class="f-left">
				<p>©2005-2020 Ministry of Education, All rights reserved.</p>
			</div>
			<div class="f-right">
